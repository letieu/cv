...
#show: rendercv.with(
  name: "LÊ CẢNH TIÊU",
  footer: context { [#emph[LÊ CẢNH TIÊU -- #str(here().page())\/#str(counter(page).final().first())]] },
...
#connections(
  ...
  [#link("https://linkedin.com/in/letieu", icon: false, if-underline: false, if-color: false)[#connection-with-icon("linkedin")[letieu]]],
)
